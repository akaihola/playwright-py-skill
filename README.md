...
- **Always Uses Playwright 1.57.0** - Exact version pinned for consistency
...
- Chromium browser (correct version for Playwright 1.57.0) - must be installed separately
- `uv` package manager (for running scripts with PEP 723 metadata)

**Note:** This skill does NOT install browsers. Chromium must be installed separately at the correct version for Playwright 1.57.0.
...
- **Playwright Version:** Always `1.57.0` (exact version)
...
- `uv` package manager (for running scripts with PEP 723 metadata)
- Playwright 1.57.0 (auto-installed via PEP 723 when running scripts)
...
Install the correct Chromium version for Playwright 1.57.0 separately. The skill does not install browsers.
